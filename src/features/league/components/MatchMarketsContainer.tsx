...
export const MatchMarketsContainer = ({ match }: { match: MatchResponse }) => {
  ...
  return (
    <Card className="mb-6 border-indigo-100 dark:border-indigo-950 shadow-sm">
      <CardHeader className="py-4 bg-indigo-50/50 dark:bg-indigo-950/20 border-b border-indigo-100 dark:border-indigo-950 flex flex-row items-center justify-between">
